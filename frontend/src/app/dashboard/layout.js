    ...
    <div className={styles.layout}>
      ...
      <aside className={`${styles.sidebar} ${isSidebarOpen ? styles.sidebarVisible : ''}`}>
        <div className={styles.logo}>
          <div className={`${styles.logoIcon} ${(user?.role === 'admin' || user?.email?.toLowerCase() === 'nidhi.sharma@nidhi.bank' || user?.email?.toLowerCase() === 'admin@nidhi.bank') ? styles.adminLogo : ''}`}>NB</div>
          <span className={styles.logoText}>
            {(user?.role === 'admin' || user?.email?.toLowerCase() === 'nidhi.sharma@nidhi.bank' || user?.email?.toLowerCase() === 'admin@nidhi.bank') ? 'Branch Head' : 'NidhiBank'}
          </span>
        </div>
        ...
        <nav className={styles.nav}>
          ...
          {(user && 
            user.role !== 'admin' && 
            user.email?.toLowerCase() !== 'admin@nidhi.bank' && 
            user.email?.toLowerCase() !== 'nidhi.sharma@nidhi.bank') && (
          ...
          {(user?.role === 'admin' || user?.email?.toLowerCase() === 'nidhi.sharma@nidhi.bank' || user?.email?.toLowerCase() === 'admin@nidhi.bank') && (
            <Link href="/dashboard/audit" className={pathname === '/dashboard/audit' ? styles.navLinkActive : styles.navLink}>
          ...
          {(user?.role === 'admin' || user?.email?.toLowerCase() === 'nidhi.sharma@nidhi.bank' || user?.email?.toLowerCase() === 'admin@nidhi.bank') && (
            <Link href="/dashboard/operations" className={pathname === '/dashboard/operations' ? styles.navLinkActive : styles.navLink}>
          ...
          {(user && 
            ...
            user.email?.toLowerCase() !== 'admin@nidhi.bank' && 
            user.email?.toLowerCase() !== 'nidhi.sharma@nidhi.bank') && (
            <Link href="/dashboard/requests" className={pathname === '/dashboard/requests' ? styles.navLinkActive : styles.navLink}>
          ...
          <div className={styles.actions}>
            ...
            <div className={styles.profile} onClick={() => { setProfileOpen(!isProfileOpen); setNotifOpen(false); }}>
              ...
              <div className={styles.userInfo}>
                ...
                <span className={styles.userRole}>{(user?.role === 'admin' || user?.email?.toLowerCase() === 'nidhi.sharma@nidhi.bank' || user?.email?.toLowerCase() === 'admin@nidhi.bank') ? 'Branch Administrator' : 'Premium Account'}</span>
              </div>
